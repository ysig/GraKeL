...
.. rst-class:: sphx-glr-script-out
 ...
 Out::
    ...
    Downloading dataset for Cuneiform..
    Extracting dataset  Cuneiform..
    Parsing dataset  Cuneiform..
    Parse was succesful..
    Deleting unzipped dataset files..
    Going back to the original directory..
    Mean values of  10 folds:
    MLG [Fast] > Accuracy: 15.31 % | Took: 7.24 s
...
**Total running time of the script:** ( 1 minutes  14.502 seconds)
