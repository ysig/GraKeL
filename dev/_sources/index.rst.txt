...
From seeing this version of the GraKeL project on the relevant **GitHub** you can start from seeing the `README <https://github.com/ysig/GraKeL/blob/develop/README.md>`_.
